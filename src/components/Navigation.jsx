          ...
          <div className="md:hidden py-4 border-t border-gray-200 bg-white/90 backdrop-blur-sm">
            {navLinks.map((link) => (
              <Link
                ...
                className={`flex items-center gap-3 px-5 py-3 rounded-md text-sm font-medium transition-all duration-200 ${
                  isActive(link.href)
                    ? "text-primary bg-gray-100"
                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                }`}
            ...
            <div className="px-5 pt-4">
              <Button
                asChild
                variant="accent"
                className="w-full bg-primary text-white hover:bg-primary/90 rounded-full transition-all duration-200"
              >
