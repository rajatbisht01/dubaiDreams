...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto max-h-xl w-full max-w-lg rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
      ...
      >
        ...
        {!isCompleted && (
          <div className={`px-8 pb-4 ${footerClassName}`}>
            <div className={`mt-4 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              {currentStep !== 1 && (
                <button
                  onClick={handleBack}
                  className={`duration-350 rounded bg-white px-4 py-1 transition ${
                    currentStep === 1
